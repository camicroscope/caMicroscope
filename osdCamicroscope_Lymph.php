...
<div id="qualitymarkuppanel" hidden>
    ...
    <label for="AlgoB" class=radio_markup> (2) AlgoB (draw thin line)</label><br>
    <p>
    <p>
        ...
        <label for="AlgoBBig" class=radio_markup> (4) AlgoB (draw thick line)</label><br>
    <p>
    <p>
        ...
        <label for="AgloBPoly" class=radio_markup> (6) AlgoB (draw polygon)</label><br>
    <p>
    <p>
