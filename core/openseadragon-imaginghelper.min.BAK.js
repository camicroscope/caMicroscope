...
!function(a, b) {
  function c() {
    this._haveImage=!0, this.imgWidth=this._viewer.viewport.contentSize.x, this.imgHeight=this._viewer.viewport.contentSize.y, this.imgAspectRatio=this.imgWidth/this.imgHeight, this._trackZoomPan();
  } function d() {
  ...
  }, b.ImagingHelper.version={versionStr: '1.1.0', major: 1, minor: 1, revision: 0}, a.extend(b.ImagingHelper.prototype, a.EventSource.prototype, {_raiseImageViewChanged: function() {
