...
//		  console.log(data);
		...
		if (alt){  //new code go here to handle Alt key for featureScape view
		   if(data.provenance.analysis.source == "human"){
              ...
              /*
                 http://129.49.249.191/featurescapeapps/featurescape/?
                 http://129.49.249.191:4500?
                 limit=1000&find={
                 "randval":"$gte":0.6222528612876604},
                 "provenance.analysis.source":"computer",
                 "provenance.analysis.execution_id":"luad:bg:20160520",
                 "provenance.image.case_id":"TCGA-05-4245-01Z-00-DX1"}
                  &db=u24_luad&c=luad
              */			  
              });
            } else {
