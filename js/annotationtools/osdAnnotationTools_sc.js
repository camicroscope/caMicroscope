...
annotools.prototype.getAnnotFilter = function (author, grade, multi) // Get Annotation from the API
{
  ...
  var jsonRequest = new Request.JSON({
    // url: IP + 'api/getAnnotSpatial_sc.php',
...
annotools.prototype.saveAnnot = function (annotation) // Save Annotations
{
  ...
  jQuery.ajax({
    'type': 'POST',
    url: 'api/Data/getAnnotSpatial_sc_sc.php',
    data: annotation,
...
annotools.prototype.generateCompositeDataset = function() { 
  ...
  */
  ...
  // code goes here{
	  ...
	  //then send job to quip_jobs service,
	  // run the script to generate composite data
	  // notify the end user after job is complete	  
  //}
