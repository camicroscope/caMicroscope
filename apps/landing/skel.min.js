...
var skel=function() {
  'use strict'; var t={breakpointIds: null, events: {}, isInit: !1, obj: {attachments: {}, breakpoints: {}, head: null, states: {}}, sd: '/', state: null, stateHandlers: {}, stateId: '', vars: {}, DOMReady: null, indexOf: null, isArray: null, iterate: null, matchesMedia: null, extend: function(e, n) {
...
t.isArray(n[i])?(t.isArray(e[i])||(e[i]=[]), t.extend(e[i], n[i])):'object'==typeof n[i]?('object'!=typeof e[i]&&(e[i]={}), t.extend(e[i], n[i])):e[i]=n[i];
    ...
    t._canUse||(t._canUse=document.createElement('div')); var n=t._canUse.style; var i=e.charAt(0).toUpperCase()+e.slice(1); return e in n||'Moz'+i in n||'Webkit'+i in n||'O'+i in n||'ms'+i in n;
  }, on: function(e, n) {
...
t.obj.breakpoints[e].active?t.obj.breakpoints[e].wasActive||t.trigger('+'+e):t.obj.breakpoints[e].wasActive&&t.trigger('-'+e);
    ...
    var n=t.obj.head; var i=e.element; return i.parentNode&&i.parentNode.tagName?!1:(t._attach||(t._attach=n.firstChild), n.insertBefore(i, t._attach.nextSibling), e.permanent&&(t._attach=i), !0);
...
document.addEventListener?!function(e, n) {
  ...
  function t(t) {
    for (r=1; t=n.shift();)t();
  } var e; var n=[]; var i=document; var a='DOMContentLoaded'; var r=/^loaded|^c/.test(i.readyState); return i.addEventListener(a, e=function() {
...
r?t():n.push(t);
  ...
  function e(t) {
    for (h=1; t=i.shift();)t();
  } var n; var i=[]; var a=!1; var r=document; var o=r.documentElement; var s=o.doScroll; var c='DOMContentLoaded'; var d='addEventListener'; var u='onreadystatechange'; var l='readyState'; var f=s?/^loaded|^c/:/^loaded|c/; var h=f.test(r[l]); return r[d]&&r[d](c, n=function() {
...
h?t():i.push(t);
  ...
  if ('string'==typeof t) return t.indexOf(e); var n; var i; var a=e?e:0; if (!this) throw new TypeError; if (i=this.length, 0===i||a>=i) return -1; for (0>a&&(a=i-Math.abs(a)), n=a; i>n; n++) if (this[n]===t) return n; return -1;
}, Array.isArray?t.isArray=function(t) {
  return Array.isArray(t);
}:t.isArray=function(t) {
  return '[object Array]'===Object.prototype.toString.call(t);
}, Object.keys?t.iterate=function(t, e) {
  if (!t) return []; var n; var i=Object.keys(t); for (n=0; i[n]&&e(i[n], t[i[n]])!==!1; n++);
}:t.iterate=function(t, e) {
  if (!t) return []; var n; for (n in t) if (Object.prototype.hasOwnProperty.call(t, n)&&e(n, t[n])===!1) break;
  ...
  if (''==t) return !0; var e=document.createElement('style'); var n=document.getElementsByTagName('script')[0]; var i=null; e.type='text/css', e.id='matchmediajs-test', n.parentNode.insertBefore(e, n), i='getComputedStyle'in window&&window.getComputedStyle(e, null)||e.currentStyle; var a='@media '+t+'{ #matchmediajs-test { width: 1px; } }'; return e.styleSheet?e.styleSheet.cssText=a:e.textContent=a, '1px'===i.width;
}:t.matchesMedia=function(t) {
  if (''==t) return !0; var e; var n; var i; var a; var r={'min-width': null, 'max-width': null}; var o=!1; for (i=t.split(/\s+and\s+/), e=0; e<i.length; e++)n=i[e], '('==n.charAt(0)&&(n=n.substring(1, n.length-1), a=n.split(/:\s+/), 2==a.length&&(r[a[0].replace(/^\s+|\s+$/g, '')]=parseInt(a[1]), o=!0)); if (!o) return !1; var s=document.documentElement.clientWidth; var c=document.documentElement.clientHeight; return null!==r['min-width']&&s<r['min-width']||null!==r['max-width']&&s>r['max-width']||null!==r['min-height']&&c<r['min-height']||null!==r['max-height']&&c>r['max-height']?!1:!0;
    ...
    var e; var n; var i; var a=navigator.userAgent; e='other', n=0, i=[['firefox', /Firefox\/([0-9\.]+)/], ['bb', /BlackBerry.+Version\/([0-9\.]+)/], ['bb', /BB[0-9]+.+Version\/([0-9\.]+)/], ['opera', /OPR\/([0-9\.]+)/], ['opera', /Opera\/([0-9\.]+)/], ['edge', /Edge\/([0-9\.]+)/], ['safari', /Version\/([0-9\.]+).+Safari/], ['chrome', /Chrome\/([0-9\.]+)/], ['ie', /MSIE ([0-9]+)/], ['ie', /Trident\/.+rv:([0-9]+)/]], t.iterate(i, function(t, i) {
