...
Spyglass.prototype.moving = function(e) {
  ...
  // this has been changed from windowToImageCoordinates to facilitate multiple images
  const imgPoint = this._targetViewer.viewport.viewerElementToImageCoordinates(point);
